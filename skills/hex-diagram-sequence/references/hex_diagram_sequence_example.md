# Business Sequence Diagram Example

This is a high-quality example of a business sequence diagram (PlantUML) mapping out a deployment and upgrade process for a PMS system. Notice how it uses colors to differentiate roles, uses notes to explain business context (marked with `#Business`), and structures the process into clear phases.
